...
def val_imagenet():
    ...
    with ExitStack() as stack:
        ...
        for images, _ in ood_loader:
            ...
            logits, scores = get_scores_fn(model, images, odc)
            # append loss:
            #scores1 = torch.cat([scores,scores],dim=0)
...
if __name__ == '__main__':
    ...
    # 
    parser.add_argument('--test_batch_size', '--tb', type=int, default=500)
    parser.add_argument('--odc', type=int, default=300)
    ...
    odc = args.odc
    # model:
    model = ResNet50(num_classes=num_classes+odc).cuda()
