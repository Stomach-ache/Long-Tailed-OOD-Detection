...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, pooling='avgpool', norm=nn.BatchNorm2d):
        ...
        self.linear_classfier0 = nn.Linear(512, num_classes)
        self.linear_classfier1 = nn.Linear(512, num_classes)
        self.linear_classfier2 = nn.Linear(512, num_classes)
    ...
    def forward_classifier(self, p4):
        ...
        logits1 = self.linear_classfier1(p4) # (10)
        logits2 = self.linear_classfier2(p4) # (10)
...
def ResNet18(num_classes=10, pooling='avgpool', norm=nn.BatchNorm2d):
    '''
    GFLOPS: 0.5579, model size: 11.1740MB
    '''
    return ResNet(BasicBlock, [2,2,2,2], num_classes=num_classes, pooling=pooling, norm=norm)

def ResNet34(num_classes=10, pooling='avgpool', norm=nn.BatchNorm2d):
    '''
    GFLOPS: 1.1635, model size: 21.2859MB
    '''
    return ResNet(BasicBlock, [3,4,6,3], num_classes=num_classes, pooling=pooling, norm=norm)
